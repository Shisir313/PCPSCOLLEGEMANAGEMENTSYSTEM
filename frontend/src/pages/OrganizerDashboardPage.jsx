...
export default function OrganizerDashboardPage() {
  ...
  const [qrTarget, setQrTarget] = useState(null); // { id, title }
                  ...
                  <div className="flex flex-col sm:flex-row gap-0">
                    ...
                    <div className="flex-1 p-5">
                      ...
                      <div className="flex flex-wrap gap-2 mt-1">
                        ...
                        <button
                          onClick={() => setQrTarget({ id: event.id, title: event.title })}
                          className="btn-outline-blue text-xs px-3 py-1.5 inline-flex items-center gap-1.5"
                        >
